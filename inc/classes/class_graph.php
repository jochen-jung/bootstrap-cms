...
var $percent_norm;
	...
	// Texts
	imagettftext($image, "10","0","150","10","255","{$GLOBALS["config"]["system"]["dir"]}/ext_inc/fonts/arial.ttf",$text["top"]);
	imagettftext($image, "10","90","10",$y_max/2,"255","{$GLOBALS["config"]["system"]["dir"]}/ext_inc/fonts/arial.ttf",$text["left"]);
	imagettftext($image, "10","270","590",$y_max/2,"255","{$GLOBALS["config"]["system"]["dir"]}/ext_inc/fonts/arial.ttf",$text["right"]);
	imagettftext($image, "10","0","300",$y_max - 10,"255","{$GLOBALS["config"]["system"]["dir"]}/ext_inc/fonts/arial.ttf",$text["buttom"]);
	...
	imagettftext($image, "8","0","400",$y_max - 35,"255","{$GLOBALS["config"]["system"]["dir"]}/ext_inc/fonts/arial.ttf","$date | lansuite 2.0 Chart");
	...
	imagettftext($image, "10","0",$x1 + 3 ,$y1 + 14,250,"{$GLOBALS["config"]['system']["dir"]}/ext_inc/fonts/arial.ttf",$line_text);
