 ...
 * @author bytekilla
 * @version $Id: class_auth.php 2419 2012-08-27 14:54:27Z Jochen.Jung $
 * @access public
    ...
    function login($email, $password, $show_confirmation = 1) {
        ...
        //else
        {
            ...
            // Email not found?
                ...
                if ($tmp_login_email != '')
                  $func->information(t('Dieser Benutzer existiert noch nicht. Unterhalb kannst du dir einen neuen Account erstellen'), NO_LINK, 1);
                //$func->log_event(t('Falsche Email angegeben (%1)', $tmp_login_email), '2', 'Authentifikation');
                include('modules/usrmgr/add.php');
            // Account disabled?
            } elseif ($user["type"] <= -1) {
