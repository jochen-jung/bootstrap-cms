    ...
    function get_menu_items() {
        ...
        while ($main_item = $db->fetch_array($res)) {
            ...
            if ($module and $main_item['module'] == $module and $main_item['action'] != 'show_info2') {
                ...
                if ($auth['type'] > 2) {
                    $AdminIcons .= $this->box->LinkItem('index.php?mod=install&amp;action=mod_cfg&amp;module='. $module, t('Mod-Konfig'), '', t('Dieses Modul verwalten'));
                    $this->box->Row($AdminIcons);
